...
- `ami_no_reboot` (bool) - Add one or more block devices before the Packer build starts. If you add
...
- `launch_block_device_mappings` (awscommon.BlockDevices) - Indicates whether or not the instance should be automatically rebooted
